    ...
    while candidates:
        ...
        for til, deltacost in movements:
            ...
            if til not in path_record:
                # Calculate the cost as the sum of actual cost and heuristic
                total_cost = dis + deltacost + heuristic(til, goal) - heuristic(curr_node, goal)
                candidates.put((total_cost, curr_node, til))
