...
def plan(event):
    ...
    if click == 0:
        ...
        path, path_px = a_star_occupancy(start_node, goal_node, copy.deepcopy(gmap), '8N')
        if path_px:
        ...
        path, path_px = dijkstra_occupancy(start_node, goal_node, copy.deepcopy(gmap), '8N')
        if path_px:
            # plot resulting path in pixels over the map
...
if __name__ == '__main__':
    ...
    img = PhotoImage(file="maps/example_map_binary.png")
